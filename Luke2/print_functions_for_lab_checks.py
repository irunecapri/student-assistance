...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        print("\n ** Statistics from calculates_results_stats() function:") # SECTIONS OUTCOMMENTED DUE TO DIFFERENT LABELLING OF THE DICTIONARY ITEMS IN STUDENTS INDIVIDUAL SOLUTION
