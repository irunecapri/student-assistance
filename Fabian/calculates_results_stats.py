...
def calculates_results_stats(results_dic):
    ...
    #results_stats_dic['pct_correct_breed'] = 0.0 # CONDITIONS ARE MISSING HERE, MUST BE:
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / 
                                          results_stats_dic['n_dogs_img'])*100.0
    
    ### OUTCOMMENTED SECTION BELOW IS NONSENSICAL, MUST BE DELETED
    #if results_stats_dic['n_dogs_img'] > 0:
     #   results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img'])*100.0
